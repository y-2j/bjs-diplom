    ...
    try {	
        getStocks((err, data) => {	
            ...
            const stocksInfo = data;	
             ...
             const Dmitry = new Profile({	
                username: 'Dmitry',	
                name: { firstName: 'Dmitry', lastName: 'Fomenko' },	
                password: 'jX98!oR*2',	
            });	
             ...
             Ivan.create((err, data) => {	
                if (err) {	
                    ...
                    Dmitry.create((err, data) => {	
                        if (err) {	
                            console.error('Error during creating Dmitry');	
                            throw err;	
                        } else {	
                            console.log('Dmitry is created!');	
                                                            ...
                                                            Ivan.transferMoney(	
                                                                ...
                                                                (err, data) => {	
                                                                    if (err) {	
                                                                        ...
                                                                        console.log(	
                                                                            `Dmitry has got ${targetAmount} NETCOINS`	
                                                                        );	
                                                                    }	
                                                                }	
                                                            );	
